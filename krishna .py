...
TOKEN = '7571272018:AAFoRlcIge-SjAXARMo7P19f3rDqdQ7zyjA'
MONGO_URI = 'mongodb+srv://rishi:ipxkingyt@rishiv.ncljp.mongodb.net/?retryWrites=true&w=majority&appName=rishiv'
FORWARD_CHANNEL_ID = -1002465964138
CHANNEL_ID = -1002465964138
error_channel_id = -1002465964138
...
async def run_attack_command_on_codespace(target_ip, target_port, duration):
    command = f"./krishna {target_ip} {target_port} {duration} 5"
    try:
...
def send_not_approved_message(chat_id):
    bot.send_message(chat_id, "*YOU ARE NOT APPROVED BUY ACESS:-@BALOT_OP*", parse_mode='Markdown')
